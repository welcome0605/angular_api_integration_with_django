...
export class TransactionBalanceComponent implements OnInit {
  ...
  balanceList: Array<any> = [
    { Account_Number: 1, _Tyoe: 'Aurelia Vega', Account_Name: 30, Starting_Balance: 'Deepends', Dr_Sum: 1, Cr_Sum: 3, Ending_Balance: 80, Curreny: 'test', Comment: 'test' },
    { Account_Number: 2, _Tyoe: 'Aurelia Vega', Account_Name: 30, Starting_Balance: 'Deepends', Dr_Sum: 1, Cr_Sum: 3, Ending_Balance: 80, Curreny: 'test', Comment: 'test' },
    { Account_Number: 3, _Tyoe: 'Aurelia Vega', Account_Name: 30, Starting_Balance: 'Deepends', Dr_Sum: 1, Cr_Sum: 3, Ending_Balance: 80, Curreny: 'test', Comment: 'test' },
  ];
